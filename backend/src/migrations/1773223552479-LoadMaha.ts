...
export class LoadMaha1773223552479 implements MigrationInterface {
    name = 'LoadMaha1773223552479'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "meetings" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "meeting_code" character varying NOT NULL, "title" character varying NOT NULL, "lobby_enabled" boolean NOT NULL DEFAULT true, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "host_id" uuid, CONSTRAINT "UQ_23734e73d5f5caadf1869dde085" UNIQUE ("meeting_code"), CONSTRAINT "PK_aa73be861afa77eb4ed31f3ed57" PRIMARY KEY ("id"))`);
