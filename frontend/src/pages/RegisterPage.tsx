...
import { Video, User, Mail, Lock, ArrowRight, ShieldCheck } from 'lucide-react';
            ...
            >
                <div className="auth-card-premium rounded-[2.5rem] p-8 md:p-10 premium-shadow relative overflow-hidden">
                    ...
                    <div className="flex flex-col items-center mb-10">
                        ...
                        <h1 className="text-3xl font-black text-[var(--auth-text-primary)] tracking-tight mb-2">Create Account</h1>
                        <p className="text-[13px] font-semibold text-[var(--auth-text-secondary)] uppercase tracking-[0.2em] opacity-90">
                            Start Video Calling In Minutes
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        <div className="space-y-2">
                            ...
                            <div className="relative group">
                                <User className="w-4 h-4 absolute left-4 top-1/2 -translate-y-1/2 text-[var(--auth-text-muted)] group-focus-within:text-[var(--auth-accent-primary)] transition-colors" />
                                <input
                                    type="text"
                                    value={name}
                    ...
                    <div className="mt-10 pt-8 border-t border-white/10 flex flex-col items-center gap-4">
                        <p className="text-[13px] text-[var(--auth-text-secondary)] font-medium">
                            ...
                            <Link to="/login" className="text-[var(--auth-accent-primary)] font-bold hover:underline">
                                Sign in
                            </Link>
                        </p>
